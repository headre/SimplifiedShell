...
command parse(char *commandinput)
{
    ...
    if(template.sequence<10&&template.sequence>=0){
        ...
        else if(strcmp(PiecePart[0],"info")==0){
            template.sequence=1;
        }
        else if(strcmp(PiecePart[0],"pwd")==0){
            template.sequence=2;
        }
        else if(strcmp(PiecePart[0],"cd")==0){
            template.sequence=3;
        }
        else if(strcmp(PiecePart[0],"ex")==0&&PiecePart[1]!=NULL){
            template.sequence=4;
        }
        else if(strcmp(PiecePart[0],"mygrep")==0&&PiecePart[3]!=NULL&&PiecePart[2]!=NULL&&strcmp(PiecePart[1],"-c")==0){
            template.sequence=5;
        }
        else if(strcmp(PiecePart[0],"clear")==0){
            template.sequence=6;
        }
        else if(strcmp(PiecePart[0],"help")==0){
            template.sequence=7;
        }else if(strcmp(PiecePart[0],"user")==0){
            template.sequence=8;
        }else
        {
            template.sequence=-1;
